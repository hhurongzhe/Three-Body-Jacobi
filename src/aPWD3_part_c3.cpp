...
std::complex<double> Gt(int idxbra, int idxket, double ppmag, double qpmag, double pmag, double qmag, double thetaq, double thetapp, double phipp, double thetaqp, double phiqp, util::WignerSymbols &wigner)
{
    ...
    {
        mtx = (Ftpe2 * Ybra(0, 0, 0, 0, thetapp, phipp, thetaqp, phiqp, wigner) *
    ...
    else if (idxbra == 3 && idxket == 3)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (2 * Sqrt(3) * (-(q2z * q3x) + Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Ybra(2, -2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) -
    ...
    {
        mtx = (Ftpe2 * (-(Sqrt(3) * q2z * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner)) - Complex(0, 1) * Sqrt(3) * q2z * q3y * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) -
    ...
    {
        mtx = -0.25 *
              (Ftpe2 * (Sqrt(6) * q2z * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) + Complex(0, 1) * Sqrt(6) * q2z * q3y * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) +
    ...
    else if (idxbra == 3 && idxket == 15)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) +
    ...
    else if (idxbra == 3 && idxket == 16)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * Ybra(0, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) *
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * (Sqrt(6) * (-(q2z * (q3x + Complex(0, 1) * q3y)) + (q2x + Complex(0, 1) * q2y) * q3z) * Yket(2, -2, 0, 2, thetaq, wigner) - Complex(0, 1) * Sqrt(6) * (q2y * q3x - q2x * q3y) * Yket(2, -1, 0, 2, thetaq, wigner) +
    ...
    {
        mtx = Ftpe2 * (q2x * q3x + q2y * q3y + q2z * q3z) *
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * (Complex(0, -1) * Sqrt(2) * (q2y * q3x - q2x * q3y) * Yket(1, -1, 2, 2, thetaq, wigner) + (-(q2z * q3x) + Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Yket(1, 0, 2, 2, thetaq, wigner)) +
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * (Sqrt(6) * (-(q2z * (q3x + Complex(0, 1) * q3y)) + (q2x + Complex(0, 1) * q2y) * q3z) * Yket(2, -2, 2, 0, thetaq, wigner) - Complex(0, 1) * Sqrt(6) * (q2y * q3x - q2x * q3y) * Yket(2, -1, 2, 0, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * (Sqrt(6) * (-(q2z * (q3x + Complex(0, 1) * q3y)) + (q2x + Complex(0, 1) * q2y) * q3z) * Yket(2, -2, 2, 2, thetaq, wigner) - Complex(0, 1) * Sqrt(6) * (q2y * q3x - q2x * q3y) * Yket(2, -1, 2, 2, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * (Sqrt(2) * (q2x * q3x + q2y * q3y - 2 * q2z * q3z) * Yket(1, -1, 1, 1, thetaq, wigner) + 3 * (q2z * q3x - Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Yket(1, 0, 1, 1, thetaq, wigner) -
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) *
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * (2 * (q2x * q3x + q2y * q3y + 4 * q2z * q3z) * Yket(1, -1, 1, 1, thetaq, wigner) - 3 * Sqrt(2) * (q2z * q3x - Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Yket(1, 0, 1, 1, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (Sqrt(3) * q2z * q3x * Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) + Complex(0, 1) * Sqrt(3) * q2z * q3y * Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (Sqrt(6) * q2z * q3x * Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) + Complex(0, 1) * Sqrt(6) * q2z * q3y * Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) +
    ...
    {
        mtx =
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 1, 1, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 1, 1, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (2 * Sqrt(3) * (q2z * q3x - Complex(0, 1) * q2z * q3y - q2x * q3z + Complex(0, 1) * q2y * q3z) * Ybra(2, -2, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * Ybra(0, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) *
               ((-(q2z * (q3x + Complex(0, 1) * q3y)) + (q2x + Complex(0, 1) * q2y) * q3z) * Yket(1, -1, 1, 1, thetaq, wigner) - Complex(0, 1) * Sqrt(2) * (q2y * q3x - q2x * q3y) * Yket(1, 0, 1, 1, thetaq, wigner) +
                (-(q2z * q3x) + Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Yket(1, 1, 1, 1, thetaq, wigner))) /
              (3. * Sqrt(2));
        return mtx;
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * (Complex(0, 1) * Sqrt(2) * (q2y * q3x - q2x * q3y) * Yket(1, -1, 1, 1, thetaq, wigner) + (q2z * q3x - Complex(0, 1) * q2z * q3y - q2x * q3z + Complex(0, 1) * q2y * q3z) * Yket(1, 0, 1, 1, thetaq, wigner)) +
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * (Sqrt(6) * (q2z * (q3x + Complex(0, 1) * q3y) - (q2x + Complex(0, 1) * q2y) * q3z) * Yket(2, -2, 1, 1, thetaq, wigner) + Complex(0, 1) * Sqrt(6) * (q2y * q3x - q2x * q3y) * Yket(2, -1, 1, 1, thetaq, wigner) +
    ...
    {
        mtx =
            -0.3333333333333333 * (Ftpe2 * (q2x * q3x + q2y * q3y + q2z * q3z) *
    ...
    {
        mtx = (Ftpe2 * (Ybra(1, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) *
    ...
    {
        mtx = -0.16666666666666666 * (Ftpe2 * (Ybra(1, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * (Sqrt(2) * (q2x * q3x + q2y * q3y - 2 * q2z * q3z) * Yket(1, -1, 2, 2, thetaq, wigner) + 3 * (q2z * q3x - Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Yket(1, 0, 2, 2, thetaq, wigner) -
    ...
    {
        mtx = -0.08333333333333333 * (Ftpe2 * (Ybra(1, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * (2 * (q2x * q3x + q2y * q3y + 4 * q2z * q3z) * Yket(1, -1, 2, 2, thetaq, wigner) - 3 * Sqrt(2) * (q2z * q3x - Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Yket(1, 0, 2, 2, thetaq, wigner) +
    ...
    else if (idxbra == 15 && idxket == 3)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (2 * Sqrt(3) * (-(q2z * q3x) + Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Ybra(2, -2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) -
    ...
    {
        mtx = (Ftpe2 * (-(Sqrt(3) * q2z * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner)) - Complex(0, 1) * Sqrt(3) * q2z * q3y * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) -
    ...
    {
        mtx = -0.25 *
              (Ftpe2 * (Sqrt(6) * q2z * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) + Complex(0, 1) * Sqrt(6) * q2z * q3y * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) +
    ...
    else if (idxbra == 15 && idxket == 15)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) +
    ...
    else if (idxbra == 15 && idxket == 16)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) +
    ...
    else if (idxbra == 16 && idxket == 3)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) +
    ...
    {
        mtx = (Ftpe2 * (2 * Sqrt(3) * (-(q2z * q3x) + Complex(0, 1) * q2z * q3y + q2x * q3z - Complex(0, 1) * q2y * q3z) * Ybra(2, -2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 1, 1, thetaq, wigner) -
    ...
    {
        mtx = (Ftpe2 * (-(Sqrt(3) * q2z * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner)) - Complex(0, 1) * Sqrt(3) * q2z * q3y * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) -
    ...
    {
        mtx = -0.25 *
              (Ftpe2 * (Sqrt(6) * q2z * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) + Complex(0, 1) * Sqrt(6) * q2z * q3y * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(1, -1, 2, 2, thetaq, wigner) +
    ...
    else if (idxbra == 16 && idxket == 15)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) +
    ...
    else if (idxbra == 16 && idxket == 16)
    {
        mtx =
            -0.05 *
            (Ftpe2 * (2 * Sqrt(6) * q2x * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) + Complex(0, 2) * Sqrt(6) * q2y * q3x * Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) +
