...
namespace aPWD3_cE
{
                            ...
                            util::WignerSymbols &wigner)
    {
        ...
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) + Ybra(2, -1, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 0, 2, thetaq, wigner) + Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 0, 2, thetaq, wigner) + Ybra(2, 1, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 0, 2, thetaq, wigner) + Ybra(2, 2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 0, 2, thetaq, wigner))) / 5.;
            return mtx;
        }
        ...
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) + Ybra(2, -1, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 2, 0, thetaq, wigner) + Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 2, 0, thetaq, wigner) + Ybra(2, 1, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 2, 0, thetaq, wigner) + Ybra(2, 2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 2, 0, thetaq, wigner))) / 5.;
            return mtx;
        }
        else if (idxbra == 3 && idxket == 16)
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) + Ybra(2, -1, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 2, 2, thetaq, wigner) + Ybra(2, 0, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 2, 2, thetaq, wigner) + Ybra(2, 1, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 2, 2, thetaq, wigner) + Ybra(2, 2, 0, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 2, 2, thetaq, wigner))) / 5.;
            return mtx;
        }
        ...
        {
            mtx = (Fct * (Ybra(2, -2, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 1, 1, thetaq, wigner) + Ybra(2, -1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 1, 1, thetaq, wigner) + Ybra(2, 0, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 1, 1, thetaq, wigner) + Ybra(2, 1, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 1, 1, thetaq, wigner) + Ybra(2, 2, 1, 1, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 1, 1, thetaq, wigner))) / 5.;
            return mtx;
        }
        ...
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) + Ybra(2, -1, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 0, 2, thetaq, wigner) + Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 0, 2, thetaq, wigner) + Ybra(2, 1, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 0, 2, thetaq, wigner) + Ybra(2, 2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 0, 2, thetaq, wigner))) / 5.;
            return mtx;
        }
        ...
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) + Ybra(2, -1, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 2, 0, thetaq, wigner) + Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 2, 0, thetaq, wigner) + Ybra(2, 1, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 2, 0, thetaq, wigner) + Ybra(2, 2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 2, 0, thetaq, wigner))) / 5.;
            return mtx;
        }
        else if (idxbra == 15 && idxket == 16)
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) + Ybra(2, -1, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 2, 2, thetaq, wigner) + Ybra(2, 0, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 2, 2, thetaq, wigner) + Ybra(2, 1, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 2, 2, thetaq, wigner) + Ybra(2, 2, 2, 0, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 2, 2, thetaq, wigner))) / 5.;
            return mtx;
        }
        ...
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 0, 2, thetaq, wigner) + Ybra(2, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 0, 2, thetaq, wigner) + Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 0, 2, thetaq, wigner) + Ybra(2, 1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 0, 2, thetaq, wigner) + Ybra(2, 2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 0, 2, thetaq, wigner))) / 5.;
            return mtx;
        }
        ...
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 0, thetaq, wigner) + Ybra(2, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 2, 0, thetaq, wigner) + Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 2, 0, thetaq, wigner) + Ybra(2, 1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 2, 0, thetaq, wigner) + Ybra(2, 2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 2, 0, thetaq, wigner))) / 5.;
            return mtx;
        }
        else if (idxbra == 16 && idxket == 16)
        {
            mtx = (-3 * Fct * (Ybra(2, -2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -2, 2, 2, thetaq, wigner) + Ybra(2, -1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, -1, 2, 2, thetaq, wigner) + Ybra(2, 0, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 0, 2, 2, thetaq, wigner) + Ybra(2, 1, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 1, 2, 2, thetaq, wigner) + Ybra(2, 2, 2, 2, thetapp, phipp, thetaqp, phiqp, wigner) * Yket(2, 2, 2, 2, thetaq, wigner))) / 5.;
            return mtx;
        }
